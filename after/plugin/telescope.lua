...
telescope.setup {
    pickers = {
        find_files = {
            find_command = {
                ...
                '--exclude', 'CMakeFiles/',
                -- '--exclude', '*/dependencies/downloads/',
                '--exclude', '*/dependencies/downloads/*/src/*-stamp',
                '--exclude', '*/dependencies/downloads/*/tmp',
            },
        },
        buffers = {
            sort_lastused = true,
    ...
    defaults = {
        ...
        vimgrep_arguments = {
            ...
            '--glob', '!CMakeFiles/',
            -- '--glob', '!*/dependencies/downloads/',
            '--glob', '!*/dependencies/downloads/*/src/*-stamp',
            '--glob', '!*/dependencies/downloads/*/tmp',
        },
